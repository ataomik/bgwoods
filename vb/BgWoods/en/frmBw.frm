...
Begin VB.Form frmBw 
   ...
   Begin VB.Frame fmeOpt 
      ...
      Begin VB.Label lblClk 
         AutoSize        =   -1  'True
         Caption         =   "Click times per second:"
         Height          =   195
         Left            =   240
         TabIndex        =   15
         Top             =   1320
...
Dim gtValue As GameType
  ...
  stbBw.Panels(1).Text = "Searching..."
  Me.MousePointer = 11
  clsBgw.SearchChrAttrs txtCurPoints.Text
  Me.MousePointer = 0
  stbBw.Panels(1).Text = "Find Result:"
  stbBw.Panels(2).Text = _
    "Str: " & CStr(clsBgw.Strength) & ", Dex: " & CStr(clsBgw.Dexterity) & _
    ", Con: " & CStr(clsBgw.Constitution) & ", Int: " & CStr(clsBgw.Intelligence) & _
    ", Wis: " & CStr(clsBgw.Wisdom) & ", Cha: " & CStr(clsBgw.Charisma)
fndErrHandle:
End Sub
...
Private Sub lvGt_Click()
  If IsNull(lvGt.SelectedItem) = False Then
    ...
    stbBw.Panels(1).Text = "Current Game:"
